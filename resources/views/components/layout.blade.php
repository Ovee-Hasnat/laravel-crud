                    ...
                    <div class="hidden md:block">
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            <div class="me-0">
                                ...
                                <x-nav-link data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                                    {{ Config::get('languages')[App::getLocale()] }}
                                </x-nav-link>

                                <!--begin::Menu 3-->
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-fit py-3"
                                    data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a class="menu-link px-3" href="{{ route('lang.switch', $lang) }}">
                                            {{$language}}</a>
                                    </div>
                                    @endif
                                    @endforeach
